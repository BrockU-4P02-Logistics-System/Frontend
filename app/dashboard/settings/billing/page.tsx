    ...
    <div className="p-4 border rounded-lg bg-card">
      ...
      <div className="mb-4 p-3 bg-primary/5 rounded-lg">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-bold">
            {formatAmountForDisplay(selectedPackage.price, config.CURRENCY)}
          </span>
        </div>
      </div>
      ...
      <form action={formAction} className="space-y-4">
        ...
        <input
          type="hidden"
          name="credits"
          value={selectedPackage.totalCredits}
        />
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your credits and payment information
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            1 USD = 10 Credits (bonuses on packages over 100 credits!)
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="flex justify-between items-center p-3 border rounded-lg">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Routes with more than 1 driver
                  </p>
                </div>
              </div>
              <div className="text-right">
            ...
            <div className="flex justify-between items-center p-3 border rounded-lg">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Save a route of any complexity
                  </p>
                </div>
              </div>
              <div className="text-right">
